...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckBoxTag = exports.CheckBoxTag = function CheckBoxTag(_ref) {
	  ...
	  var checkedValue = _ref$checkedValue === undefined ? 1 : _ref$checkedValue;
	  var _ref$uncheckedValue = _ref.uncheckedValue;
	  var uncheckedValue = _ref$uncheckedValue === undefined ? 0 : _ref$uncheckedValue;

	  var props = _objectWithoutProperties(_ref, ["checkedValue", "uncheckedValue"]);

	  return React.createElement(
	    "span",
	    null,
	    React.createElement(HiddenFieldTag, { name: props.name, value: uncheckedValue }),
	    React.createElement("input", _extends({ type: "checkbox", value: checkedValue }, props))
	  );
	};
